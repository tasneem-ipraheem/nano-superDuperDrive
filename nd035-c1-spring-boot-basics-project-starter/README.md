...
The Super*Duper*Drive, is a product aiming to make a dent in the Cloud Storage market like Google Drive and Dropbox in addation to include personal information management features in their application to differentiate them from the competition, 

## The product includes three user-facing main features:
...
## Starter Project
It's a Maven project configured for all the dependencies the project requires. 
The database schema for the project is added o the `src/main/resources` directory. 

I created some HTML templates from the design team's website mockups, and placed them in the `src/main/resources/templates` folder. the Pages is configured with Thymeleaf to add functionality and real data from the server you develop also they support testing the application.


## Requirements and Roadmap
the application implements the followimg TODO tasks:
